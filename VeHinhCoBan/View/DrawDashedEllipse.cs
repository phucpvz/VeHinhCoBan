...
{
    public partial class DrawDashedEllipse : UserControl
    {
        private FBaiTap main;
        public FBaiTap Main { get => main; set => main = value; }

        public DrawDashedEllipse(FBaiTap main)
        {
            InitializeComponent();
            Main = main;
        }
        ...
        private void btnDraw_Click(object sender, EventArgs e)
        {
            ...
            Main.Shapes.Add(new HinhElip(x0, y0, a, b, Main.Color1, Color.Transparent, new int[] { 2, 2 }));
            Main.Refresh();
        }
    }
}
