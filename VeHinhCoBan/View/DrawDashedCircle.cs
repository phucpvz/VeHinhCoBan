...
{
    public partial class DrawDashedCircle : UserControl
    {
        private FBaiTap main;
        public FBaiTap Main { get => main; set => main = value; }

        public DrawDashedCircle(FBaiTap main)
        {
            InitializeComponent();
            Main = main;
        }
        ...
        private void btnDraw_Click(object sender, EventArgs e)
        {
            ...
            Main.Shapes.Add(new HinhTron(x0, y0, r, Main.Color1, Color.Transparent, new int[] { 2, 2 }));
            Main.Refresh();
        }
    }
}
