...
{
    public partial class Draw1DottedLine : UserControl
    {
        private FBaiTap main;
        public FBaiTap Main { get => main; set => main = value; }

        public Draw1DottedLine(FBaiTap main)
        {
            InitializeComponent();
            Main = main;
        }
        ...
        private void btnDraw_Click(object sender, EventArgs e)
        {
            ...
            Main.Shapes.Add(new DoanThang(x1, y1, x2, y2, Main.Color1, new int[] { 4, 1, 1, 1 }));
            Main.Refresh();
        }
    }
}
