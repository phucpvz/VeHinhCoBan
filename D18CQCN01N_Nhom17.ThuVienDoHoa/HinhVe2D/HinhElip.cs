...
namespace D18CQCN01N_Nhom17.ThuVienDoHoa.HinhVe2D
{
    public class HinhElip : Hinh2D
    {
        ...
        public HinhElip(Diem2D tam, int a, int b, Color? foreColor = null, Color? backColor = null, int[] doDaiCacNet = null)
        {
            Tam = tam;
            A = a;
            B = b;
        ...
        public HinhElip(int xO, int yO, int a, int b, Color? foreColor = null, Color? backColor = null, int[] doDaiCacNet = null)
        ...
        public override void VeHinh(DoHoa2D dh)
        {
            ...
            dh.VeHinhElip(Tam, a, b, DoDaiCacNet);
        }
    }
}
